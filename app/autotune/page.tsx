...
export const metadata: Metadata = { title: "Automatic PID Tuning Lab", description: "Compare validated FOPDT and ultimate-cycle PID tuning methods, including Ziegler–Nichols, Cohen–Coon, CHR, IMC, SIMC, Tyreus–Luyben, and simulated relay feedback.", alternates: { canonical: "/autotune/" } };
