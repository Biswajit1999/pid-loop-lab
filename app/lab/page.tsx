...
export const metadata: Metadata = { title: "PID Simulator Lab", description: "Run a deterministic PIDF simulation with plant models, non-ideal effects, live internal telemetry, metrics, and exports." };
